...
The selected-project entries are layout positions, not claims about existing projects. Titles, links, categories, and media must be replaced together from verified project information.
